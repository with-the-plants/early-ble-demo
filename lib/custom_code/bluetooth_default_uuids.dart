...
enum BluetoothDefaultServiceUUID {
  ...
  ///
  const BluetoothDefaultServiceUUID(this.name, this.uuid16, this.uuid);
...
enum BluetoothDefaultCharacteristicUUID {
  ...
  /// as its uuid represented as a 16 bit uuid and a full 128 bit uuid.
  ///
  const BluetoothDefaultCharacteristicUUID(this.name, this.uuid16, this.uuid);
